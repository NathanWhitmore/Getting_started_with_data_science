...
\subsubsection*{Data: a self assessment}

\begin{itemize}
  \item What is the question we are asking?
  \item How will we use this information to influence decision making?
  \item Who are the decision makers?
  \item What type of data will we need to collect to answer our question?  
  \item How much data will we need to collect to answer our question?
  \item How do we know the data can be analysed?
  \item How will we analyse the data?
  \item Who will we analyse the data?
  \item How will we enter the data?
  \item How can we make sure the data is free of mistakes?
  \item How can we make sure the data is safeguarded against loss?
  \item How can we make sure the analysis is safeguarded against loss?
  \item How can we make sure the we understand the outcome of the analysis?
  \item How can we make sure the decision makers understand the outcome of the analysis?
\end{itemize}



\section*{Building a data strategy}
